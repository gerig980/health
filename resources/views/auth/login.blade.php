...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login-Dashboard | Health Travel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Admin Dashboard - SkyRights" name="description" />
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                ...
                                </script> HealthTravel. Crafted with <i class="mdi mdi-heart"></i> by BigMediaExpert
                            </p>
                        </div>
                    </div>
                </div>
